...
public class CrossPlatformActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String text = "<html><body>" + "<p align=\"justify\">"
                + getString(R.string.crossplatformapp) + "</p> " + "</body></html>";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.map) {
            Intent mapIntent = new Intent(CrossPlatformActivity.this,MapsActivity.class);
            startActivity(mapIntent);
        }
        if (id == R.id.fb) {
            Intent mapIntent = new Intent(CrossPlatformActivity.this,FollowFacebook.class);
            startActivity(mapIntent);
        }
        if (id == R.id.aboutus) {
            Intent mapIntent = new Intent(CrossPlatformActivity.this,AboutUs.class);
            startActivity(mapIntent);
        }
