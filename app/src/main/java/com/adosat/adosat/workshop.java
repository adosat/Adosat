...
public class workshop extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String text = "<html><body>" + "<p align=\"justify\">"
                + getString(R.string.workshops) + "</p> " + "</body></html>";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.map) {
            Intent mapIntent = new Intent(workshop.this,MapsActivity.class);
            startActivity(mapIntent);
        }
        if (id == R.id.fb) {
            Intent mapIntent = new Intent(workshop.this,FollowFacebook.class);
            startActivity(mapIntent);
        }
        if (id == R.id.aboutus) {
            Intent mapIntent = new Intent(workshop.this,AboutUs.class);
            startActivity(mapIntent);
        }
