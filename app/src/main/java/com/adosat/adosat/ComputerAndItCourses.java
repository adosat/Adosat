...
public class ComputerAndItCourses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_and_it_courses);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.map) {
            Intent mapIntent = new Intent(ComputerAndItCourses.this,MapsActivity.class);
            startActivity(mapIntent);
        }

        if (id == R.id.fb) {
            Intent mapIntent = new Intent(ComputerAndItCourses.this,FollowFacebook.class);
            startActivity(mapIntent);
        }
