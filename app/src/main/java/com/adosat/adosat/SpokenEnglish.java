...
public class SpokenEnglish extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.map) {
            Intent mapIntent = new Intent(SpokenEnglish.this,MapsActivity.class);
            startActivity(mapIntent);
        }
        if (id == R.id.fb) {
            Intent mapIntent = new Intent(SpokenEnglish.this,FollowFacebook.class);
            startActivity(mapIntent);
        }
        if (id == R.id.aboutus) {
            Intent mapIntent = new Intent(SpokenEnglish.this,AboutUs.class);
            startActivity(mapIntent);
        }
